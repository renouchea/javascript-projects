...
let threeDimensionalArray = [
  ...
  console.log(threeDimensionalArray[0]);          // Print one entry from the first level
  console.log(threeDimensionalArray[1][0]);       // Print one entry from the second level
  console.log(threeDimensionalArray[2][1][2]);